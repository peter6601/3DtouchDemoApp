...
extension TestViewController: UIViewControllerPreviewingDelegate{
    ...
    func previewingContext(previewingContext: UIViewControllerPreviewing, viewControllerForLocation location: CGPoint) -> UIViewController? {
        ...
        guard let previewVC = storyboard?.instantiateViewControllerWithIdentifier("showItem") as? ItemViewController else {return nil}
    ...
    func previewingContext(previewingContext: UIViewControllerPreviewing, commitViewController viewControllerToCommit: UIViewController) {
        if let stuffVC = storyboard?.instantiateViewControllerWithIdentifier("showItem") as? ItemViewController{
